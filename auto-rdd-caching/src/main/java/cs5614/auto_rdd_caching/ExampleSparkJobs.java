...
/* This class contains the implementation for various Spark jobs
 */
public class ExampleSparkJobs
{
     ...
     */
    protected static RDD<?> job1(JavaSparkContext sc, boolean verbose)
    {
     ...
     * @return: the final RDD in the job, useful for lineage
     */
    protected static RDD<?> job2(JavaSparkContext sc, boolean verbose)
    {
        // 1. Get csv data and filter out header
        // Verbose function
        JavaRDD<String> airportData = DataReader.getAirportData(sc);
     ...
     * @return: the final RDD in the job, useful for lineage
     */
    protected static RDD<?> job3(JavaSparkContext sc, boolean verbose)
    {
     ...
     * @return: the final RDD in the job, useful for lineage
     */
    protected static RDD<?> job4(JavaSparkContext sc, boolean verbose)
    {
     ...
     * @return: the final RDD in the job, useful for lineage
     */
    protected static RDD<?> job5(JavaSparkContext sc, boolean verbose)
    {
        JavaRDD<String> flightsData = DataReader.getFlights(sc);
        JavaPairRDD<String, Tuple3<String, String, String>> flightsTuples =
                flightsData.mapToPair(
